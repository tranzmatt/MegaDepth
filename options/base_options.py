...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--inputImage', type=str, help='input image name')
        ...
        self.parser.add_argument('--checkpointName', type=str, default='best_vanila', help='models are saved here')
